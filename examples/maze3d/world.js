      ...
      m: {
        ...
        nodes: {
          ...
          fps_range: {
            ...
            look: '装甲目标封锁着走廊。你初始携带精确手枪;先拾取正前方的近程霰弹枪并自动装备,近距打出一次散射,再按 1 切回精确手枪收尾,最后穿过发光 D。首次移动、转向、开火或点击画面才会让追逐与攻击计时开始;初始画面可以安全阅读。首次点击画面只开始追逐并锁定鼠标,不会开枪。\n\n第二格的 +3 弹药只补给精确手枪,侧路有 +20 health 医疗包。有效射击、空仓、切换和获得武器各有工业短音;全局回稳期间重复按下不会耗弹或缓冲。',
            wonText: '生存场出口打开。你完成了近程霰弹枪散射、切回精确手枪收尾并穿过既有 D 出口的完整闭环。',
            maze: {
              grid: [
                '#############',
                '#...........#',
              ...
              combat: {
                ...
                equipped: 'precision',
                guard: { x: 7, y: 3, hp: 60, hitRadius: 0.34,
