...
var TESTS = [
  ...
  ['examples/horror-journey','examples/horror-demo/test/horror-journey.test.cjs'],
  ['tabletop/module',         'modules/tabletop/test/tabletop.test.cjs'],
  ['examples/tabletop-journey','examples/tabletop-demo/test/tabletop-journey.test.cjs'],
  ['minimal/module',          'modules/minimal/test/minimal.test.cjs'],
  ['examples/minimal-journey','examples/minimal-demo/test/minimal-journey.test.cjs'],
  ...
  ['examples/arcade-journey', 'examples/arcade-demo/test/arcade-journey.test.cjs'],   // R·06正式world:goal=5五果解锁、三败分流、abort与固定runtime SHA
  ...
  ['examples/maze3d-gallery', 'examples/maze3d/test/gallery.test.cjs'], // Visual Gallery:Node inventory单源、协调recipe/combat family与复制文本
  ['examples/maze3d-recipe-dogfood', 'examples/maze3d/test/recipe-dogfood.test.cjs'], // recipe正式节点机械闸:非视觉hash、坐标冲突、Origin前缀与runtime SHA
  ['examples/maze3d-puzzle-experience', 'examples/maze3d/test/puzzle-experience.test.cjs'], // tests-first:显式BASELINE存旧线性证据；正式runner只接受PUZZLE_KIT
  ['examples/maze3d-fps-encounter-kit', 'examples/maze3d/test/fps-encounter-kit.test.cjs'], // tests-first:正式runner拒绝BASELINE；KIT切相后锁BFS/预算/freeze/反变异
  ['examples/maze3d-pursuit-experience', 'examples/maze3d/test/pursuit-experience.test.cjs'], // tests-first:显式BASELINE存always-on旧态；正式runner只因phase gate拒绝旧态
  ...
  ['examples/cutscene-journey','examples/cutscene-demo/test/cutscene-journey.test.cjs'], // R·03正式world:compiler wiring、末拍门控、shore普通scene回接与load/reset
