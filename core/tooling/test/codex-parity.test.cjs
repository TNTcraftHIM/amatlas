...
try {
  ...
  (function () {
    ...
    var formalOrder = /core runtime[^\n]*cutscene runtime[^\n]*DOM[^\n]*timeline[^\n]*compile-performance[^\n]*SVG[^\n]*world[^\n]*boot[^\n]*game/;
    ok('10g cutscene reference 与 Claude/Codex skill 锁正式九段加载顺序，AGENTS 只路由',
      /正式装配顺序见该 reference/.test(agents) && formalOrder.test(cutsceneRef) && formalOrder.test(claudeSkill) && formalOrder.test(skill));
