...
(function (global, factory) {
  ...
  /* Accept decimal seconds with at most millisecond precision; absorb only IEEE-754 product noise. */
  ...
  function normalizeMotionPlan(motion, options) {
    ...
    return deepFreeze({ layers: layers, tracks: tracks });
  }
  ...
  function compileReveal(textPlan, options) {
    ...
    return deepFreeze({ mode: 'typewriter', lines: lines, graphemes: graphemes, durationMs: cursorMs });
  }
