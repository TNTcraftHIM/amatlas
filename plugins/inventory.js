...
(function (global, factory) {
  ...
  function createInventoryPlugin(opts) {
    ...
    var api = null, btnEl = null, panelEl = null, backdropEl = null, closeEl = null, warnedBad = false, warnedIcon = false;
    ...
    function mountUI() {
      ...
      panelEl = doc.createElement('div'); panelEl.className = 'amatlas-plugin-panel amatlas-inv-panel';
      backdropEl = doc.createElement('div'); backdropEl.className = 'amatlas-plugin-backdrop'; backdropEl.setAttribute('aria-hidden', 'true');
      setPanelOpen(false);
      closeEl = doc.createElement('button'); closeEl.className = 'amatlas-plugin-close'; closeEl.textContent = '✕'; closeEl.setAttribute('title', '关闭'); closeEl.onclick = function () { setPanelOpen(false); };
      btnEl.onclick = function () { var open = panelEl.hidden; setPanelOpen(open); if (open) renderList(); };
